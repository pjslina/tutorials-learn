package com.panjin.spring.kafka.multiplelisteners;
...
public class KafkaProducerConfig {
    ...
    public ProducerFactory<String, BookEvent> bookProducerFactory() {
        ...
        configProps.put(JsonSerializer.TYPE_MAPPINGS, "bookEvent:com.panjin.spring.kafka.multiplelisteners.BookEvent");
